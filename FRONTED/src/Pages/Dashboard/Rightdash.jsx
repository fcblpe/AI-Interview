...
const Rightdash = () => {
 ...
 <div className='bg-purple-50 mt-7 h-screen w-260 rounded-2xl'>
 <div className="ml-3 mt-1 flex justify-between items-start">
  <div>
    ...
    <p className="text-xs text-gray-600 mt-1">
      Let's keep going! Your Dream Job is Closer Than You Think.
    </p>
  </div>

  <div className="mr-67 mt-1 w-44 text-xs italic text-gray-700">
    <p>"Practice with purpose,</p>
    <p>and let your progress speak."</p>
  </div>
</div>
  

     <div className='flex gap-0'> 
      <div className='bg-white h-23 w-45 mx-2 mt-3 rounded-2xl flex'>
  ...
  <FaRegFileAlt className='absolute mt-2 ml-2 text-purple-900 text-xl'size={16} />
        ...
        <div className='bg-white h-23 w-45  mt-3 rounded-2xl flex'>
